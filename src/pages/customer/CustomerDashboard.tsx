...
export function CustomerDashboard() {
  ...
  const handleSwitchToSupplier = async () => {
    try {
      await switchRole('supplier');
      navigate('/supplier/dashboard');
      toast.success('Modo fornecedor ativado');
    } catch (error) {
  ...
  const menuItems = [
    ...
    { icon: Calendar, label: 'Minhas Reservas', path: '/customer/dashboard/bookings' },
    { icon: Heart, label: 'Favoritos', path: '/customer/dashboard/favorites' },
    { icon: MessageSquare, label: 'Chat', path: '/customer/dashboard/chat' },
    { icon: User, label: 'Meu Perfil', path: '/customer/dashboard/profile' },
  ];
